...
SECRET_KEY = 'django-insecure-id!&=9wrtjnnb!x@(hro^@c-c6#rjao61$ec#12iy(@#(2#2o-'
...
DATABASES = {
    'default': {
        ...
        'NAME': os.getenv('DB_NAME', 'social_media_api'),      # database name
...
REST_FRAMEWORK = {
    'DEFAULT_AUTHENTICATION_CLASSES': [
        ...
        # 'rest_framework.authentication.SessionAuthentication',  # keep for dev if you want the browsable API
    ],
